...
export class Downloads {
  ...
  async getDurationInSeconds(fileName, bucket) {
    ...
    if (!(bucket in REGIONS_MAP)) {
      const errorMessage = `Invalid Bucket Name: '${bucket}'. Bucket must be a supported Google Cloud Storage Region Name. View https://cloud.google.com/storage/docs/locations for more information.`;
      throw new Error(errorMessage);
    }
